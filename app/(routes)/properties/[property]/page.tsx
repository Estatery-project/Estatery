...
export async function generateStaticParams() {
    const posts = await fetch(
        'https://estate-api-0bne.onrender.com/estates'
    ).then((res) => res.json())
                                ...
                                <div className="w-full  mt-4">
                                    ...
                                    <div className="border-t-[2px]  border-opacity-5 border-t-[#000929] mt-10">
                                        <p className="font-[500] opacity-[0.5] text-[#000929]  mt-12">
                                            ...
                                            & Privacy Policy. By choosing to
                                            contact a property, you also agree
                                            that Estatery Group, landlords, and
                                            property managers may call or text
                                            you about any inquiries you submit
                                            through our services, which may
                                            involve use of automated means and
                                            prerecorded/artificial voices. You
                                            don't need to consent as a condition
                                            of renting any property, or buying
